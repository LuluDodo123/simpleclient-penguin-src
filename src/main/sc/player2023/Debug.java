...
public class Debug {
    ...
    /**
     * Die Anzahl von Punten welcher ein berechneter Zug hat.
     */
    public static final String MOVE_POINTS = "move-points";
    ...
    public void log(String id) {
        ...
        switch (id) {
            ...
            case MOVE_POINTS -> movePoints(getArgs(id));
        }
        log.info("");
    }
    ...
    private void movePoints(Object[] args) { 
        if ((int) args[1] > (int) args[2]) {
            log.info("{} {} Punkte! Neue Höchstpunktzahl!", args[0], args[1]);
        } else {
            log.info("{} {} Punkte!", args[0], args[1]);
        }
    }
